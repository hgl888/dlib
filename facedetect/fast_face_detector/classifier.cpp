...
void Classifier::load(const std::string &_filename)
{
    ...
    m_opts.stride = pt.get<unsigned int>("classifier.opts.stride");
    ...
    for(unsigned int j = 0; j < fids.at(0).size(); ++j)
    {
    ...
    for(unsigned int j = 0; j < thrs.at(0).size(); ++j)
    {
    ...
    for(unsigned int j = 0; j < child.at(0).size(); ++j)
    {
    ...
    for(unsigned int j = 0; j < hs.at(0).size(); ++j)
    {
    ...
    for(unsigned int j = 0; j < depth.at(0).size(); ++j)
    {
